            ...
            <section className="weather__body">
                ...
                <div className="weather__info">
                    ...
                    <ul className="weather__list">
                        ...
                        <li className="weather__list-item"><span className="weather__list-label">Pressures</span> <span className="weather__list-value">{weather?.main.pressure} hPa</span></li>
                    </ul>
                </div>
            </section>
            <footer className="weather__footer">
                <h2 className="weather__temp">{isCelsius ? `${temp?.celsius} ºC` : `${temp?.farenheit} ºF`}</h2>
                <button className="weather__btn" onClick={handleChangeTemp}>Chage to {isCelsius ? 'ºF' : 'ºC'}</button>
            </footer>
